...
import com.sapa.solulife.activities.ScheduleActivity;
...
public class MainFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        schedulec = (RelativeLayout) mainView.findViewById(R.id.holder_relative_layout_schedule);
        ...
        schedulec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
